...
const sensors = [
  {
    id: "AZM_Intraday",
    label: "AZM Intraday",
    link: "/1/user/[user-id]/activities/active-zone-minutes/date/[start-date]/[end-date]/[detail-level]/time/[start-time]/[end-time].json",
    ...
    arguments: ['user-id', 'start-date', 'end-date', 'detail-level', 'start-time', 'end-time'],
    parameters: ['timezone']
  },
  {
    id: "Activity_Intraday",
    label: "Activity Time Series Intraday",
    link: "/1/user/[user-id]/activities/[resource]/date/[start-date]/[end-date]/[detail-level]/time/[start-time]/[end-time].json",
    ...
    arguments: ['user-id', 'resource', 'start-date', 'end-date', 'detail-level', 'start-time', 'end-time'],
    parameters: []
  },
  {
